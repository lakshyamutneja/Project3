...
curl -H "Content-Type: text/plain" -H "token: ae92a07f-b2f5-43bf-a767-e83093dd50cf" --request PUT --data "arn:aws:s3:::udapeople-7488448" https://api.memstash.io/values/backend
